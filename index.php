...
setcookie("roomType", ""); setcookie("nAdult", ""); 
// setcookie("checkinDate", ""); setcookie("checkoutDate", "");
    ...
    <section class="ftco-booking">
    	<div class="container">
    		<div class="row">
				...
				<!-- Form -->
				<form action="display-rooms.php" class="booking-form" method="POST">
	        		<div class="row">
    			...
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					...
    					<div class="text p-3 text-center">
    						<h3 class="mb-3"><a href="rooms.html">Economic Room</a></h3>
    						<p><span class="price mr-2">$120.00</span> <span class="per">per night</span></p>
    						<hr>
    						<p class="pt-1"><a href="#" class="btn-custom"></a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					...
    					<div class="text p-3 text-center">
    						...
    						<p><span class="price mr-2">$220.00</span> <span class="per">per night</span></p>
    						<hr>
    						<p class="pt-1"><a href="#" class="btn-custom"></a></p>
    					</div>
    				</div>
    			...
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					...
    					<div class="text p-3 text-center">
    						...
    						<p><span class="price mr-2">$180.00</span> <span class="per">per night</span></p>
    						<hr>
    						<p class="pt-1"><a href="#" class="btn-custom"></a></p>
    					</div>
    				</div>
